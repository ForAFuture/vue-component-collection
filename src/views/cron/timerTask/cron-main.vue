  ...
  computed: {
    tableData () {
      ...
      return this.hideSecond || this.hideYear
        ? c.concat({ name: 'Cron:', value: this.cronValue_c })
        : c.concat(
    ...
    cronValue_c () {
      ...
      if (!this.hideYear && !this.hideSecond) {
  ...
  methods: {
    ...
    calTriggerListInner () {
      ...
      try {
        ...
        this.$message.error('请设置正确的表达式，错误信息:' + e.message)
      }
    },
    calStartTime () {
